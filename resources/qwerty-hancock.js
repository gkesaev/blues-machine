...
(function (window, undefined) {
    ...
    var init = function (us) {
        ...
        settings = {
            ...
            octaves:        user_settings.octaves || 1,
    ...
    var getAbcOfNote = function (note) {
    ...
    var getMIDIOfNote = function (note) {
        ...
        console.log("getMIDIOfNote " + key_number);
        return key_number;
    };
    /**
    ...
    */
    var mouseDown = function (element, callback) {
        if (element.tagName.toLowerCase() == 'li') {
            ...
            callback(element.title, getMIDIOfNote(element.title));
        }
    };
    ...
    */
    ...
    var getKeyPressedForMidi = function (keyCode) {
        return key_map[keyCode]
            .replace('l', parseInt(settings.startOctave, 10) + settings.keyPressOffset)
            .replace('u', (parseInt(settings.startOctave, 10) + settings.keyPressOffset + 1)
                .toString());
